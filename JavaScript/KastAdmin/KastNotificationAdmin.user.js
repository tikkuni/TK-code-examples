// ==UserScript==
// @name         Kast Notification
// @namespace    http://kast.gg/
// @version      0.1
// @description  Beeps at Message sent
// @author       Tkay
...
//goal: Notify on message sent, different sound of important messages.
(function() {
    ...
    var wordsToBeepTo = ['help', '?', 'how do', 'what do', 'pls', 'please', 'cummies', 'Tkay', 'how to', 'night', 'bye', 'see you']
    var myUsername = "Tkay"
    ...
    setInterval(function(){ // this is each interval
        ...
        for(var i = chatLogLength - 1; i > 0; i--){
            ...
            if(username.trim() === myUsername.trim()) continue; // add this. continue means just do the next thing in the for loop > MAKe the sense to me :D
            // break means end for loop entirely. continue means jump to the end of the current cycle of i. " hello    ".trim() would be "hello" :D
    ...
    var checker = function checker(messageText, wordsArray){ // like dat
        var m = messageText.toLowerCase().trim()
        var splitUpMessagePerWord = m.split(/\b/) // that's regex. regular expressions. it's a way of searching text with stuff. \b is words ye
